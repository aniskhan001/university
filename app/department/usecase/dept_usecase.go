...
type DeptUsecase interface {
	Get(c echo.Context, id uint) (*repo.DeptResp, error)
	List(c echo.Context) ([]repo.DeptResp, error)
	Insert(c echo.Context) (*repo.DeptResp, error)
	InsertMany(c echo.Context) ([]repo.DeptResp, error)
}
